<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="saleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="药店ID" align="center" prop="saleId" />
      <el-table-column label="药店名称" align="center" prop="saleName" />
      <el-table-column label="联系电话" align="center" prop="salePhone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="药店名称" prop="saleName">
          <el-input v-model="form.saleName" placeholder="请输入药店名称" />
        </el-form-item>
        <el-form-item label="联系电话" prop="salePhone">
          <el-input v-model="form.salePhone" placeholder="请输入联系电话" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除商店信息编号为"' + saleIds + '"的数据项？').then(function() {
