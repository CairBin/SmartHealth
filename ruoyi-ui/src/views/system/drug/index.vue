<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="drugList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="药品图片URL" align="center" prop="drugImg" /> -->
      <el-table-column label="药品图片" align="center" prop="drugImg">
        <template slot-scope="scope">
          <img :src="scope.row.drugImg" alt="图片" width="40" height="40" />
        </template>
      </el-table-column>
      <el-table-column label="药品成分" align="center" prop="drugInfo" />
      <el-table-column label="药品功效" align="center" prop="drugEffect" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="药品图片URL" prop="drugImg">
          <el-input v-model="form.drugImg" placeholder="请输入药品图片URL" />
        </el-form-item>
        <el-form-item label="药品成分" prop="drugInfo">
          <el-input v-model="form.drugInfo" placeholder="请输入药品成分" />
        </el-form-item>
        <el-form-item label="药品功效" prop="drugEffect">
          <el-input v-model="form.drugEffect" placeholder="请输入药品功效" />
        </el-form-item>
        <el-form-item label="药品名称" prop="drugName">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除药物信息编号为"' + drugIds + '"的数据项？').then(function() {
